...
<div class="row span9 offset3">
<h1>PHP Fundamentals</h1>
<p>You will be expected to have an understanding of each of these key areas of PHP.</p>

<h4>Using PHP scripts</h4>
<ul>
	<li>Incorporate PHP script into a web page</li>
	<li>Include other php and html files into a script</li>
</ul>
...
<h4>Date and Time</h4>
<ul>
	<li>Create a string of the current date in a variety of formats</li>
	<li>Make basic date calculations</li>
</ul>
...
<h4>Controlling Application flow</h4>
<ul>
...
<h4>Sessions</h4>
<ul>
	<li>Know how use <code>sessions</code> in an application</li>
	<li>Create a cookie</li>
	<li>Test for cookie and session variables</li>
</ul>

<h4>Files</h4>
<ul>
	<li>Iterate over a directory of files</li>
	<li>Write a new line to a file</li>
	<li>Overwrite a whole file</li>
	<li>Read a file's contents</li>
</ul>
